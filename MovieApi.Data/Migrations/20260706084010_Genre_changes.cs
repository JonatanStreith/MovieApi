...
namespace MovieApi.Data.Migrations
{
    ...
    public partial class Genre_changes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "MovieId", "Duration", "GenreId", "Title", "Year" },
                values: new object[,]
                {
                    { 1, 126, 1, "Iron Man 1", 2008 },
                    { 2, 124, 1, "Iron Man 2", 2010 },
                    { 3, 130, 1, "Iron Man 3", 2013 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "OMIGOD THIS IS THE BEST MOVIE EVER!", 1, "Iron Man 1", 5, "Chester A. Bum" },
                    { 2, "A distasteful look into the horrifying military complex. Also, Marvel just keeps pumping these out. This is, what, the fifth one in the series?", 1, "Iron Man 1", 1, "Snooty McNitpick" },
                    { 3, "Tony looks so hot in this one. Shame about the ending. I wrote a fanfic that fixed everything, read it at http://wwwfanfic.con/340694hgio/a/", 3, "Iron Man 3", 5, "StarkLovr4908" },
                    { 4, "A fascinating adaptation of long-running comics continuity adapted into film. A shame TONY DIES IN ENDGAME!", 1, "Iron Man 1", 5, "Doug Spoilerton" },
                    { 5, "Are all these reviews made up? Whatever. I liked the movie.", 2, "Iron Man 2", 4, "Richard Normalman" }
                });
